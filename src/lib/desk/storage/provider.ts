 ...
 *
 * Everything in src/lib/desk/ (parser, CRUD, file-cache, search) reaches the
 ...
 * mode. A future server runs the same domain layer against a NodeFsProvider /
 * S3Provider by calling setStorage() at boot — no domain code changes.
 *
