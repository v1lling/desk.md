 ...
 *
 * Mirrors the StorageProvider registry in ../storage. External code (stores,
 * components, hooks) MUST reach domain operations through getDeskService();
 * code inside src/lib/desk keeps calling the domain functions directly.
 */
